...
/**
 * @ingroup  main_coredriver
 * @brief    This macro defines the Custom Name for \ref MAIN_CORE_MainResetCallbackRegister API
 */
#define MSIInterface_MainResetCallbackRegister MAIN_CORE_MainResetCallbackRegister
 ...
 * @ingroup    main_coredriver
 * @brief      This function can be used to override default callback and to define 
 *             custom callback for MAIN_CORE MainReset event.
 * @param[in]  handler - Address of the callback function.  
 * @return     none
 */
 ...
 * @brief    This is the default callback with weak attribute. The user can 
 *           override and implement the default callback without weak attribute 
 *           or can register a custom callback function using  \ref MAIN_CORE_MainResetCallbackRegister.
 * @param    none
 * @return   none  
 */
